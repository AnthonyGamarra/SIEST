...
def create_dash_app(flask_app, url_base_pathname='/dashboard_cq/'):
        ...
        if ficha_id is not None:
            title_row_children.append(
                dbc.Button(
                    ...
                    id={'type': 'ficha-btn-cq', 'ficha_id': ficha_id},
    ...
    def serve_layout():
        ...
        if getattr(current_user, "is_authenticated", False):
            ...
            return dbc.Container([
                ...
                dbc.Modal(
                    [
                        dbc.ModalHeader(dbc.ModalTitle(id='ficha-modal-title-cq'), close_button=True),
                        dbc.ModalBody(
                            html.Iframe(
                                id='ficha-modal-iframe-cq',
                ...
                dcc.Store(id='ficha-clicks-store-cq', data={}),
    ...
    @dash_app.callback(
        Output('ficha-modal-cq', 'is_open'),
        Output('ficha-modal-iframe-cq', 'src'),
        Output('ficha-modal-title-cq', 'children'),
        Output('ficha-clicks-store-cq', 'data'),
        Input({'type': 'ficha-btn-cq', 'ficha_id': ALL}, 'n_clicks'),
        State({'type': 'ficha-btn-cq', 'ficha_id': ALL}, 'id'),
        State('ficha-clicks-store-cq', 'data'),
        prevent_initial_call=True,
    )
    def show_ficha_tecnica_cq(n_clicks_list, ids_list, prev_clicks):
