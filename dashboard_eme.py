...
def create_dash_app(flask_app, url_base_pathname='/dashboard_alt/'):
        ...
        if ficha_id is not None:
            title_row_children.append(
                dbc.Button(
                    ...
                    id={'type': 'ficha-btn-eme', 'ficha_id': ficha_id},
    ...
    def serve_layout():
        ...
        if getattr(current_user, "is_authenticated", False):
            ...
            return dbc.Container([
                ...
                dbc.Modal(
                    [
                        dbc.ModalHeader(dbc.ModalTitle(id='ficha-modal-title-eme'), close_button=True),
                        dbc.ModalBody(
                            html.Iframe(
                                id='ficha-modal-iframe-eme',
                ...
                dcc.Store(id='ficha-clicks-store-eme', data={}),
    ...
    @dash_app.callback(
        Output('ficha-modal-eme', 'is_open'),
        Output('ficha-modal-iframe-eme', 'src'),
        Output('ficha-modal-title-eme', 'children'),
        Output('ficha-clicks-store-eme', 'data'),
        Input({'type': 'ficha-btn-eme', 'ficha_id': ALL}, 'n_clicks'),
        State({'type': 'ficha-btn-eme', 'ficha_id': ALL}, 'id'),
        State('ficha-clicks-store-eme', 'data'),
        prevent_initial_call=True,
    )
    def show_ficha_tecnica_eme(n_clicks_list, ids_list, prev_clicks):
